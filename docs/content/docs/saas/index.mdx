...
Birch SaaS extends Birch with a SaaS offering that provides flexible credential management modes, policy orchestration, team collaboration, and enterprise features—all while maintaining full open-source transparency.

## Overview

Birch SaaS offers three operating modes:
...
Birch SaaS supports flexible per-provider credential management:
...
Full API documentation available at [api.birch.sh/docs](https://api.birch.sh/docs)
...
2. Log in to Birch SaaS: `birch saas login`
